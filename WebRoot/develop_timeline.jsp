				...
				<div class="col-md-12">
					<ul class="timeline">
						<li class="timeline-yellow">
							...
							<div class="timeline-body">
								...
								<div class="timeline-content">
									...
									讨论《杭州布罗沃服饰有限公司中期验货报告》、《（范例）女成人CVA14006CP（A) 两件套》、《范例：2014年上半年BRAVO GARMENTS总单》等需求文档
								</div>
							...
							<div class="timeline-body">
								...
								<div class="timeline-content">
									<div class="scroller" data-height="175px" data-always-visible="1" data-rail-visible1="1">
										<p>演示内容</p>
										<p>登陆页面</p>
										<p>系统主页:系统图标(商标)、登陆信息、消息提示、统计数字、系统菜单、订单提醒、任务提醒、日程安排、聊天记录、统计图表、主页布局、系统风格</p>
										<p>订单列表：操作按钮、数据项、搜索、图片列、图片放大、分页</p>
										<p>总单录入:分页显示、总单内容、样品意见、辅料列表</p>
										<p>其它</p>
									</div>
								</div>
								<div class="timeline-footer">
						...
						<li class="timeline-grey">
							...
							<div class="timeline-body">
								<h2>第二阶段开发工作结束，实现报表打印和数据同步功能</h2>
								<div class="timeline-content">
									 第二阶段完成报表打印和数据导出功能
								</div>
								<div class="timeline-footer">
